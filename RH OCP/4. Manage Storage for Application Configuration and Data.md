...
apiVersion: apps/v1 ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
kind: Deployment ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
metadata: ![3](https://rol.redhat.com/rol/static/roc/Common_Content/images/3.svg)
  name: hello-deployment
spec: ![4](https://rol.redhat.com/rol/static/roc/Common_Content/images/4.svg)
  replicas: 1
  selector:
    matchLabels:
  ...
  template:
    metadata:
      labels:
        app: hello-deployment
    spec: ![5](https://rol.redhat.com/rol/static/roc/Common_Content/images/5.svg)
      containers:
      - env: ![6](https://rol.redhat.com/rol/static/roc/Common_Content/images/6.svg)
        - name: ENV_VARIABLE_1
          valueFrom:
            secretKeyRef:
              key: hello
...
apiVersion: v1
kind: ConfigMap ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
metadata:
  name: example-configmap
  namespace: my-app
data: ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
  ...
  example.property.file: |-
    ...
    property.2=value-2
    property.3=value-3
binaryData: ![3](https://rol.redhat.com/rol/static/roc/Common_Content/images/3.svg)
  bar: L3Jvb3QvMTAw
...
metadata:
  name: example-secret
  namespace: my-app
type: Opaque ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
data: ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
  username: bXl1c2VyCg==
  password: bXlQQDU1Cg==
stringData: ![3](https://rol.redhat.com/rol/static/roc/Common_Content/images/3.svg)
...
metadata:
  ...
  namespace: example-app ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
data:
  database.name: sakila ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
  database.user: redhat ![3](https://rol.redhat.com/rol/static/roc/Common_Content/images/3.svg)
...
spec:
  containers:
    - name: example-container
      ...
      env: ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
        - name: MYSQL_DATABASE ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
          valueFrom:
            configMapKeyRef:
              name: config-map-example ![3](https://rol.redhat.com/rol/static/roc/Common_Content/images/3.svg)
              key: database.name ![4](https://rol.redhat.com/rol/static/roc/Common_Content/images/4.svg)
        - name: MYSQL_USER
          valueFrom:
            configMapKeyRef:
              name: config-map-example![5](https://rol.redhat.com/rol/static/roc/Common_Content/images/5.svg)
              key: database.user ![6](https://rol.redhat.com/rol/static/roc/Common_Content/images/6.svg)
              optional: true ![7](https://rol.redhat.com/rol/static/roc/Common_Content/images/7.svg)
...
spec:
  containers:
    - name: example-container
      image: registry.example.com/mysql-80:1-237
      command: [ "/bin/sh", "-c", "env" ]
  envFrom: ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
    - configMapRef:
        name: config-map-example ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
  restartPolicy: Never
    ...
    - name: secret-test-container
      ...
      env: ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
        - name: TEST_SECRET_USERNAME_ENV_VAR
          valueFrom: ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
            secretKeyRef: ![3](https://rol.redhat.com/rol/static/roc/Common_Content/images/3.svg)
              name: test-secret ![4](https://rol.redhat.com/rol/static/roc/Common_Content/images/4.svg)
              key: username ![5](https://rol.redhat.com/rol/static/roc/Common_Content/images/5.svg)
...
apiVersion: v1
kind: PersistentVolume ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
metadata:
  name: block-pv ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
spec:
  capacity:
    storage: 10Gi ![3](https://rol.redhat.com/rol/static/roc/Common_Content/images/3.svg)
  accessModes:
    - ReadWriteOnce ![4](https://rol.redhat.com/rol/static/roc/Common_Content/images/4.svg)
  volumeMode: Block ![5](https://rol.redhat.com/rol/static/roc/Common_Content/images/5.svg)
  persistentVolumeReclaimPolicy: Retain ![6](https://rol.redhat.com/rol/static/roc/Common_Content/images/6.svg)
  fc: ![7](https://rol.redhat.com/rol/static/roc/Common_Content/images/7.svg)
...
metadata:
  _...output omitted..._
  namespace: storage-volumes ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
  _...output omitted..._
spec:
  _...output omitted..._
  template:
  ...
  _...output omitted..._
        **`volumeMounts:`**
        - mountPath: /var/lib/example-app ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
          name: example-pv-storage ![3](https://rol.redhat.com/rol/static/roc/Common_Content/images/3.svg)
  _...output omitted..._
      **`volumes:`**
      - name: example-pv-storage ![4](https://rol.redhat.com/rol/static/roc/Common_Content/images/4.svg)
        persistentVolumeClaim:
          claimName: example-pv-claim ![5](https://rol.redhat.com/rol/static/roc/Common_Content/images/5.svg)
  _...output omitted..._
...
metadata:
  name: example-pv-claim ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
  labels:
...
spec:
  ...
  resources:
    requests:
      storage: 15Gi ![4](https://rol.redhat.com/rol/static/roc/Common_Content/images/4.svg)
...
apiVersion: storage.k8s.io/v1 ![1](https://rol.redhat.com/rol/static/roc/Common_Content/images/1.svg)
kind: StorageClass ![2](https://rol.redhat.com/rol/static/roc/Common_Content/images/2.svg)
metadata:
  name: io1-gold-storage ![3](https://rol.redhat.com/rol/static/roc/Common_Content/images/3.svg)
  annotations: ![4](https://rol.redhat.com/rol/static/roc/Common_Content/images/4.svg)
    storageclass.kubernetes.io/is-default-class: 'false'
    description:'Provides RWO and RWOP Filesystem & Block volumes'
    ...
parameters: ![5](https://rol.redhat.com/rol/static/roc/Common_Content/images/5.svg)
  type: io1
  iopsPerGB: "10"
    ...
provisioner: kubernetes.io/aws-ebs ![6](https://rol.redhat.com/rol/static/roc/Common_Content/images/6.svg)
reclaimPolicy: Delete ![7](https://rol.redhat.com/rol/static/roc/Common_Content/images/7.svg)
volumeBindingMode: Immediate ![8](https://rol.redhat.com/rol/static/roc/Common_Content/images/8.svg)
allowVolumeExpansion: true ![9](https://rol.redhat.com/rol/static/roc/Common_Content/images/9.svg)
